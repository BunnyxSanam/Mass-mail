...
if not BOT_TOKEN:
    ...
    BOT_TOKEN = "7438331710:AAHK7_u2RgKjYSmo5XYtk4uwfpjXH-AzIj8" # Fallback if not in secrets

if not BOT_TOKEN:
    print("FATAL ERROR: Bot token is not configured. Set it in Replit Secrets or hardcode it.")
    exit()

OWNER_ID = 7478752901 # !!! REPLACE WITH YOUR ID !!!
...
async def cmd_help(message: types.Message, state: FSMContext):
    ...
    help_text += "\n<b>🧠 Bot by:</b> <a href='https://t.me/sanam_kinggod'>@sanam_kinggod</a>"
